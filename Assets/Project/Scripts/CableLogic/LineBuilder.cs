...
public class LineBuilder : MonoBehaviour
{
    ...
    [SerializeField] private Sprite teslaOn;
    ...
    private void Start()
    {
        firstCableCreator = staitions[staitions.Count - 1].GetComponent<CableCreator>();
    ...
    private void MakeLines()
    {
        ...
        for (int i = 1; i < staitions.Count; i++)
            staitions[i].GetComponent<SpriteRenderer>().sprite = teslaOn;
